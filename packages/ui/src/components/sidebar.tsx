  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative inset-y-0 z-10 flex h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear",
            side === "left"
  ...
  return (
    <section
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(40svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
        className,
      )}
      {...props}
    />
