...
export default function MainContentLayout({
  ...
  return (
    <div className="flex w-full shrink-0 flex-col items-center bg-neutral-950 shadow-md will-change-transform dark:shadow-white/10 lg:min-w-[1024px]  lg:max-w-[1650px]">
      {navbar}
